...
${OBJECTDIR}/src/CApplication.o: src/CApplication.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -I/usr/include/apache2 -I/usr/include/apr-1 -I/usr/local/include -I/usr/include -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CApplication.o src/CApplication.cpp

${OBJECTDIR}/src/mod_foo.o: src/mod_foo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -I/usr/include/apache2 -I/usr/include/apr-1 -I/usr/local/include -I/usr/include -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mod_foo.o src/mod_foo.cpp
